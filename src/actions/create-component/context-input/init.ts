export const init =
  `We write full stack code. Each project configuration
contains information about the project structure,
...
3. Create the full stack code for the component based on the project configuration.
4. Provide images for the component without the HTML text so the user can upload the assets.
5. Write another component for a section in the admin to manage the content of the component. This should be full stack as well. 
`;
